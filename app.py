...
# ------------------------------------------
# Added a layout column specifically for the new reload button
...
with btn_col:
    # This button natively forces the app to rerun and pull fresh data
    if st.button("🔄 Reload Data", use_container_width=True):
        st.toast("Telemetry Refreshed Successfully!", icon="✅")
